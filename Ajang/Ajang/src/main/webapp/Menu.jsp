...
<body>
	...
	<div class="title">
		<img src="img/MainLogo.png" alt="걸음마 로고" class="logo-image"> <a
			class="com" href="Info.jsp">소개</a> <a class="com" href="News.jsp">WITHKIDS</a>
		<a class="com" href="BoardMain.jsp">게시판</a> <a class="com"
			...
			class="chat-image"></a> <a href=""
			onclick="togglePopup(); return false;"><img src="img/Mypage2.png"
			alt="마이페이지" class="mypage-image"></a> <a href="LogoutService"><img
