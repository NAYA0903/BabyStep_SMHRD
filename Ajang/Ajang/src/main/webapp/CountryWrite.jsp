...
<body>
       ...
       <div class="container">
	<form action="CountryService" method="post" enctype="multipart/form-data">
          <div class="card">
             <h2>내 물건 팔기</h2>
        ...
        <div class="form-group">
            ...
            <input type="file" id="file4" name="file4">
             ...
             <div class="form-group">
                <input type="number" id="price" name="price" placeholder="₩ 가격을 입력해주세요." required>
             </div>
             ...
             <div class="form-group">
                ...
                <textarea id="content" name="content" placeholder="쌍령동에 올릴 게시글 내용을 작성해 주세요." required></textarea>
             </div>
