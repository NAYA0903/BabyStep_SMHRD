...
public class ChatMessageDAO {
    ...
    public void saveMessage(String roomId, String message) {
        ...
        chatMessage.setRoomIdx(Integer.parseInt(roomId));
        chatMessage.setChatContent(message);
        chatMessage.setChattedAt(new java.util.Date()); // 메시지 전송 시간 설정
    ...
    public List<String> getMessages(String roomId) {
        ...
        return sqlSession.selectList("com.babystep.db.ChatMapper.selectChatMessagesByRoomId", roomId);
    }
}
