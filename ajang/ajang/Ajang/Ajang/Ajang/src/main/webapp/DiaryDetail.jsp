    ...
    <div class="diary-detail-container">
        ...
        <div class="diary-detail-entries">
            ...
            <div class="diary-detail-entry">
                ...
                <div class="diary-detail-image-container" id="slider-<%=diary.getDI_IDX()%>">
                    <%
                    ...
                    <span class="diary-detail-prev" onclick="prevImage('slider-<%=diary.getDI_IDX()%>')">&#10094;</span>
                    <span class="diary-detail-next" onclick="nextImage('slider-<%=diary.getDI_IDX()%>')">&#10095;</span>
                    <%
                ...
                <div class="diary-detail-entry-content-wrapper">
                    <div class="diary-detail-entry-details">
                        ...
                        <div class="weight">
                            아기 몸무게: <%=diary.getDI_WEIGHT()%></div>
                    </div>
                    <div class="diary-detail-diary-content"><%=diary.getDI_CONTENT()%></div>
                </div>
            </div>
            <%
            }
