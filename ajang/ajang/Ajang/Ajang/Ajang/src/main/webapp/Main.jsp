...
<body>
	...
	<%=holidayMapJson%>
		...
		function loadTodoList(year, month, day) {
			...
			xhr.open("GET", "TodoListServlet?year=" + year + "&month=" + month
					+ "&day=" + day, true);
		...
		function loadimageList(year, month, day) {
			var xhr = new XMLHttpRequest();
			xhr.open("GET", "ImageDiaryServlet?year=" + year + "&month="
					+ month + "&day=" + day, true);
			xhr.onreadystatechange = function() {
				if (xhr.readyState == 4 && xhr.status == 200) {
		...
		function loadDiaryList(year, month, day) {
			var xhr = new XMLHttpRequest();
			xhr.open("GET", "DetailDiaryServlet?year=" + year + "&month="
					+ month + "&day=" + day, true);
			xhr.onreadystatechange = function() {
				if (xhr.readyState == 4 && xhr.status == 200) {
		...
		function loadScheduleList(year, month, day) {
			var xhr = new XMLHttpRequest();
			xhr.open("GET", "ScheduleListServlet?year=" + year + "&month="
					+ month + "&day=" + day, true);
			xhr.onreadystatechange = function() {
				if (xhr.readyState == 4 && xhr.status == 200) {
